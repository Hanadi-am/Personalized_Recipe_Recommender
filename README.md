...
For this project, after cleaning the original dataset in (full_cleaned_data) the final data shape was 19,265 instances and 14 feature which are:
| Feature         | Description |
|  :---:          |   :---:     |
|  name           | recipe name |
